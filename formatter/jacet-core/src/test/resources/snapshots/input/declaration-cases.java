...
abstract class AbstractGenericContainerNodeServiceBase<E extends AbstractContainerInterface, I> implements AbstractGenericNodeService<E, I> {
...
abstract class GenericExtends<E extends AbstractContainerInterface, I> extends AbstractExplanationNotesServiceBaseImplementationClass<E, I> {
...
class DeclarationMethodCases {
  ...
  public void example() {
    ...
    var result = list.stream().filter(x -> x > 1).toList();
  }
}
